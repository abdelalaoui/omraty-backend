...
public class JwtService {
  ...
  public String generateAccessToken(UUID userId, String phone) {
    return generateToken(userId, phone, TokenType.ACCESS, Duration.ofMinutes(accessTokenExpirationMinutes));
  }

  public String generateRefreshToken(UUID userId, String phone) {
    return generateToken(userId, phone, TokenType.REFRESH, Duration.ofDays(refreshTokenExpirationDays));
  }
