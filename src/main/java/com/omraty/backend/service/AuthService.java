...
public class AuthService {
  ...
  public AuthResult login(String phone, String password) {
    User user =
        authRepository
            .findByPhone(phone)
            .orElseThrow(() -> new AuthException.InvalidCredentialsException("Identifiants invalides"));
  ...
  public AuthResult refresh(String refreshToken) {
    ...
    if (!jwtService.isRefreshToken(refreshToken)) {
      throw new AuthException.InvalidRefreshTokenException("Le token fourni n'est pas un refresh token");
    }

    RefreshToken storedToken =
        authRepository
            .findRefreshToken(refreshToken)
            .orElseThrow(() -> new AuthException.InvalidRefreshTokenException("Refresh token introuvable"));
    ...
    User user =
        authRepository
            ...
            .orElseThrow(() -> new AuthException.InvalidRefreshTokenException("Utilisateur introuvable"));
  ...
  private AuthResult issueTokens(User user) {
    ...
    LocalDateTime expiresAt =
        LocalDateTime.ofInstant(jwtService.getExpiration(refreshToken), ZoneId.systemDefault());
