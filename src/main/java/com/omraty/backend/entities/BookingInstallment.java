 ...
 * attendant une vraie passerelle de paiement). reminderSentAt n'est renseigné que pour la 3e
 * tranche : marque qu'une notification de rappel a déjà été envoyée au client (voir
 * PaymentReminderService), pour ne la notifier qu'une seule fois.
 */
